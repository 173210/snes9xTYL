...
int get_pad(void)
{
  ...
  else if (paddata.Ly <= 0x30) paddata.Buttons|=PSP_CTRL_UP;    // UP
  else if (paddata.Lx <= 0x30) paddata.Buttons|=PSP_CTRL_LEFT;  // LEFT
  else if (paddata.Lx >= 0xD0) paddata.Buttons|=PSP_CTRL_RIGHT; // RIGHT

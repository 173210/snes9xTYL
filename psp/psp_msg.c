...
t_err_entry s9xTYL_msg[LANGUAGE_NUMBER][MSG_TOTAL_ENTRIES]= {
 { //english
		...
		{ERR_READ_MEMSTICK,"Last used Directory not available.\nDid you rename the directory?",60},
		//confirm
  	{ASK_EXIT,"Exit Snes9X Euphoria ?",-2},
    ...
    {FILER_HELP_WINDOW3,"Press L+R to exit.",0},
  	...
  	{MENU_SOUND_MODE_NOTEMUL,"Not Emulated",0},
		{MENU_SOUND_MODE_EMULOFF,"Disabled",0},
  	{MENU_SOUND_MODE_EMULON,"Enabled",0},  	
  	...
  	{MENU_ICONS_GAME_NEW,"Load new game",0},
		...
		{MENU_ICONS_GAME_EXIT,"Exit Snes9x Euphoria",0},
		// LOAD/SAVE
		...
		{MENU_ICONS_VIDEO_MODE_HELP,"Change the aspect ratio\nFullscreen is advised",0},		
		{MENU_ICONS_VIDEO_ENGINE,"Engine",0},	
		{MENU_ICONS_VIDEO_ENGINE_HELP,"For the best speed\nUse the 'Fast' Engine.\nIf you experience GFX issues\nTry the 'Fast + Approx' engine",0},		
		...
		{MENU_ICONS_VIDEO_FSKIP_HELP,"Helps speed up the game by\nonly updating the screen every \nX number of seconds.\nIf your game isn't running at 60FPS\nTry setting this to 2 Or 3.",0},		
		...
		{MENU_ICONS_VIDEO_VSYNC_HELP,"Use this if you are experiencing\na lot of screen tearing",0},		
		...
		{MENU_ICONS_VIDEO_SHOWFPS_HELP,"Show the FPS the Game\nIs running at",0},		
		// SOUND OPTIONS
		...
		{MENU_ICONS_ABOUT_VERSION,"Version info",0},
 }

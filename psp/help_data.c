...
static const char *help_data_ml[HELP_LANG_TOTAL][HELP_TOTAL_ENTRIES] = {
	[HELP_EN] = {
	//english
		[HELP_SHOWPASS] = "Show how much call to rendering function was needed to\ncompute the screen. The lowest, the fastest.\nThis is usefull to check the impact of hacks (below)",

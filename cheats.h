...
int S9xAddCheat (bool8 enable, bool8 save_current_value, uint32 address,
		  uint8 byte);
...
void S9xStartCheatSearch (struct SCheatData *sd);
void S9xSearchForChange (struct SCheatData *sd, S9xCheatComparisonType cmp,
                         S9xCheatDataSize size, bool8 is_signed, bool8 update);
void S9xSearchForValue (struct SCheatData *sd, S9xCheatComparisonType cmp,
                        S9xCheatDataSize size, uint32 value,
                        bool8 is_signed, bool8 update);
void S9xOutputCheatSearchResults (struct SCheatData *sd);

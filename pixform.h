...
enum { RGB565, RGB555, BGR565, BGR555, GBR565, GBR555, RGB5551, BGR444 };

#define BUILD_PIXEL(R,G,B) ((*GPUPack.GFX.BuildPixel) (R, G, B))
#define BUILD_PIXEL2(R,G,B) ((*GPUPack.GFX.BuildPixel2) (R, G, B))
#define DECOMPOSE_PIXEL(Pixel,R,G,B) ((*GPUPack.GFX.DecomposePixel) (Pixel, R,G,B))
...
// BGR444 format
#define BUILD_PIXEL_BGR444(R,G,B) (((int) ((B)>>1) << 8) | ((int) ((G)>>1) << 4) | ((int) (R)>>1))
#define BUILD_PIXEL2_BGR444(R,G,B) (((int) ((B)>>1) << 8) | ((int) ((G)>>1) << 4) | ((int) (R)>>1))
#define DECOMPOSE_PIXEL_BGR444(PIX,R,G,B) {(B) = (((PIX) >> 8)&0x0f)<<1; (G) = (((PIX) >> 4) & 0x0f)<<1; (R) = (((PIX)>>0) & 0x0f)<<1; }
#define SPARE_RGB_BIT_MASK_BGR444 (1 << 12)

#define MAX_RED_BGR444		  15
#define MAX_GREEN_BGR444	  15
#define MAX_BLUE_BGR444		  15
#define RED_LOW_BIT_MASK_BGR444   0x0100
#define GREEN_LOW_BIT_MASK_BGR444 0x0010
#define BLUE_LOW_BIT_MASK_BGR444  0x0001
#define RED_HI_BIT_MASK_BGR444    0x0800
#define GREEN_HI_BIT_MASK_BGR444  0x0080
#define BLUE_HI_BIT_MASK_BGR444   0x0008
#define FIRST_COLOR_MASK_BGR444   0x000F
#define SECOND_COLOR_MASK_BGR444  0x00F0
#define THIRD_COLOR_MASK_BGR444   0x0F00
#define ALPHA_BITS_MASK_BGR444    0xF000

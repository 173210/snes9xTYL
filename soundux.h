...
#ifdef ME_SOUND
EXTERN_C SoundStatus stSoundStatus_value;
EXTERN_C SoundStatus* stSoundStatus_p;
#define stSoundStatus (*stSoundStatus_p)
#else
...
#ifdef ME_SOUND
//EXTERN_C SSoundData SoundData_value;
//EXTERN_C SSoundData* SoundData_p;
//#define SoundData (*SoundData_p)

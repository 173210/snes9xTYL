...
void S9xSyncSRTC(time_t st)
{
  ...
  memory_cartrtc_write( 8, rtc_time->tm_mon + 1);
  memory_cartrtc_write( 9, rtc_time->tm_year % 10);
  memory_cartrtc_write(10, (rtc_time->tm_year / 10) % 10);
  memory_cartrtc_write(11, (rtc_time->tm_year / 100) + 9);

...
extern int Loop [16];*/
#ifdef ME_SOUND
SoundStatus __attribute__((aligned(64))) stSoundStatus_value;
SoundStatus * __attribute__((aligned(64))) stSoundStatus_p=(SoundStatus*)UNCACHE_PTR(&stSoundStatus_value);
//SSoundData __attribute__((aligned(64))) SoundData_value;
//SSoundData * __attribute__((aligned(64))) SoundData_p=(SSoundData*)UNCACHE_PTR(&SoundData_value);
...
//#undef IAPUuncached
//SIAPU IAPUuncached;
//SIAPU * const Uncache_Uncache_IAPU_p=(SIAPU *)UNCACHE_PTR(&IAPUuncached);
SIAPU * const Uncache_Uncache_IAPU_p=(SIAPU *)UNCACHE_PTR(&IAPU);
//#define IAPUuncached (*Uncache_Uncache_IAPU_p)

//SAPU APU4Uncache;
//SAPU * const Uncache_Uncache_APU_p=(SAPU *)UNCACHE_PTR(&APU4Uncache);
//#undef APUuncached
SAPU * const Uncache_Uncache_APU_p=(SAPU *)UNCACHE_PTR(&APUPack.APU);
//#define APUuncached (*Uncache_Uncache_APU_p)

SAPURegisters* const Uncache_APURegisters_p=(SAPURegisters*)UNCACHE_PTR(&APURegisters);
//struct SAPURegisters APURegistersUncached;
//struct SAPURegisters APURegisters4Uncached;
//SAPURegisters* const Uncache_APURegisters_p=(SAPURegisters*)UNCACHE_PTR(&APURegisters4Uncached);
...
volatile int *apu_init_after_load_=(int*)UNCACHE_PTR(&stAPUEvents.apu_init_after_load);
#define apu_init_after_load (*apu_init_after_load_)
volatile int *apu_can_execute_p,*apu_ram_write_cpt1_p,*apu_ram_write_cpt2_p;
#endif

...
typedef struct {
	...
	volatile int apu_event1_cpt1,apu_event2_cpt1,apu_event1_cpt2,apu_event2_cpt2;
	volatile int apu_init_after_load,apu_can_execute,apu_ram_write_cpt1,apu_ram_write_cpt2;
	volatile int apu_event1[65536*2],apu_event2[65536*2];
	volatile unsigned short apu_ram_write_log[65536*2];
}SAPUEVENTS;
extern volatile SAPUEVENTS stAPUEvents;
#ifndef ME_SOUND
...
#ifdef ME_SOUND
extern volatile int32 * Uncache_APU_Cycles_p;
extern uint8 *Uncache_APU_OutPorts_p;
extern volatile bool8 * Uncache_IAPU_APUExecuting_p;
...
//extern SIAPU* Uncache_Uncache_IAPU_p;
//#define IAPUuncached (*Uncache_Uncache_IAPU_p)

//EXTERN_C SAPU *Uncache_Uncache_APU_p;
//#define APUuncached (*Uncache_Uncache_APU_p)
#define APUuncached APUPack.APU

//EXTERN_C  SAPURegisters*  Uncache_APURegisters_p;
